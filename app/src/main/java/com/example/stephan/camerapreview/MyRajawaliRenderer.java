...
/**
 * Created by Stephan on 23.06.15.
 */
public class MyRajawaliRenderer extends RajawaliRenderer implements SensorEventListener{
    ...
    public void updateCamera(){
        ...
        double rotx = Math.toDegrees(gyroMatrix[0]);
        double roty = Math.toDegrees(gyroMatrix[1]);
        double rotz = Math.toDegrees(gyroMatrix[2]);

        getCurrentCamera().setRotation(rotx, roty, rotz);
        Log.d("Camera Rotation", "X: " +rotx + " y: " + roty
                + " Z: " + rotz);
    }
